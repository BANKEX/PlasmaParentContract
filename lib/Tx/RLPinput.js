const {blockNumberLength,
  ...
  class TransactionInput {
    ...
    getUTXOnumber() {
      ...
      blockNumber.iushln((txOutputNumberLength + txNumberLength)*8);
      blockNumber.iadd(txNumberInBlock.ushln(txNumberLength*8));
      blockNumber.iadd(outputNumberInTransaction);
      return blockNumber;
    }
